...
struct qt_meta_stringdata_CLASSpanENDCLASS_t {};
static constexpr auto qt_meta_stringdata_CLASSpanENDCLASS = QtMocHelpers::stringData(
    "pan",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSpanENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSpanENDCLASS_t qt_meta_stringdata_CLASSpanENDCLASS = {
    {
        QT_MOC_LITERAL(0, 3),  // "pan"
        QT_MOC_LITERAL(4, 24),  // "on_btn_startgame_clicked"
        QT_MOC_LITERAL(29, 0),  // ""
        QT_MOC_LITERAL(30, 19),  // "on_btn_stop_clicked"
        QT_MOC_LITERAL(50, 19),  // "on_btn_lose_clicked"
        QT_MOC_LITERAL(70, 12),  // "get_btn_sign"
        QT_MOC_LITERAL(83, 3),  // "idx"
        QT_MOC_LITERAL(87, 22),  // "on_btn_restart_clicked"
        QT_MOC_LITERAL(110, 15)   // "on_back_clicked"
    },
    "pan",
    "on_btn_startgame_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSpanENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject pan::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSpanENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSpanENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSpanENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *pan::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSpanENDCLASS.stringdata0))

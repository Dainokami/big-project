...
public:
    ...
    void setupUi(QWidget *pan)
    {
        ...
        widget = new QWidget(pan);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(750, 60, 295, 28));
